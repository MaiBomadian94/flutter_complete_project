...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $SignUpStatesCopyWith<T, $Res> {
...
class Failure<T> implements SignUpStates<T> {
...
@override
String toString() {
  return 'SignUpStates<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $SignUpStatesCopyWith<T, $Res> {
